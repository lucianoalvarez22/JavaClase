...
public class LeerPorTeclado {
	...
	public void procesandoCaracter(char caracterNuevo) throws VocalException, NumeroException, BlancoException, SalidaException {
 
		if (Character.toLowerCase(caracterIntroducido) == 'a' || Character.toLowerCase(caracterIntroducido) == 'e'
				|| Character.toLowerCase(caracterIntroducido) == 'i'
				|| Character.toLowerCase(caracterIntroducido) == 'o'
				|| Character.toLowerCase(caracterIntroducido) == 'u') {
